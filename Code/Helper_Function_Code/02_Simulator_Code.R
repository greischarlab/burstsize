...
FULL_MODEL_SIMULATING_Duration <- function(initial_value, mu_M_value){
  ##########################################################
  ...
  write.csv(FULL_MODEL_PC_DT, file = here(
    "Output", "Full_Model",
    paste("FULL_MODEL_PC_DT_",initial_value,".csv")))
  ...
  write.csv(Fitness_MODEL_PC_FULL, file = here(
    ...
    paste("FITNESS_MODEL_PC_",initial_value,".csv")))
